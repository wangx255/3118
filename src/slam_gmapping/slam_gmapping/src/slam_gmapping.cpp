...
void SlamGmapping::init()
{
    ...
    // ! DECLARE PARAMETERS
    this->declare_parameter("throttle_scans", rclcpp::ParameterValue(1));
    this->declare_parameter("base_frame", rclcpp::ParameterValue("base_link"));
    this->declare_parameter("map_frame", rclcpp::ParameterValue("map"));
    this->declare_parameter("odom_frame", rclcpp::ParameterValue("odom"));
    this->declare_parameter("map_update_interval", rclcpp::ParameterValue(5.0));
    this->declare_parameter("maxUrange", rclcpp::ParameterValue(80.0));
    this->declare_parameter("sigma", rclcpp::ParameterValue(0.05));
    this->declare_parameter("kernelSize", rclcpp::ParameterValue(1));
    this->declare_parameter("lstep", rclcpp::ParameterValue(0.05));
    this->declare_parameter("astep", rclcpp::ParameterValue(0.05));
    this->declare_parameter("iterations", rclcpp::ParameterValue(5));
    this->declare_parameter("lsigma", rclcpp::ParameterValue(0.075));
    this->declare_parameter("ogain", rclcpp::ParameterValue(3.0));
    this->declare_parameter("lskip", rclcpp::ParameterValue(0));
    this->declare_parameter("minimumScore", rclcpp::ParameterValue(0.0));
    this->declare_parameter("srr", rclcpp::ParameterValue(0.1));
    this->declare_parameter("srt", rclcpp::ParameterValue(0.2));
    this->declare_parameter("str", rclcpp::ParameterValue(0.1));
    this->declare_parameter("stt", rclcpp::ParameterValue(0.2));
    this->declare_parameter("linearUpdate", rclcpp::ParameterValue(1.0));
    this->declare_parameter("angularUpdate", rclcpp::ParameterValue(0.5));
    this->declare_parameter("temporalUpdate", rclcpp::ParameterValue(-1.0));
    this->declare_parameter("resampleThreshold", rclcpp::ParameterValue(0.5));
    this->declare_parameter("particles", rclcpp::ParameterValue(30));
    this->declare_parameter("xmin", rclcpp::ParameterValue(-100.0));
    this->declare_parameter("ymin", rclcpp::ParameterValue(-100.0));
    this->declare_parameter("xmax", rclcpp::ParameterValue(100.0));
    this->declare_parameter("ymax", rclcpp::ParameterValue(100.0));
    this->declare_parameter("delta", rclcpp::ParameterValue(0.05));
    this->declare_parameter("llsamplerange", rclcpp::ParameterValue(0.01));
    this->declare_parameter("llsamplestep", rclcpp::ParameterValue(0.01));
    this->declare_parameter("lasamplerange", rclcpp::ParameterValue(0.005));
    this->declare_parameter("lasamplestep", rclcpp::ParameterValue(0.005));
    this->declare_parameter("transform_publish_period", rclcpp::ParameterValue(0.05));
    this->declare_parameter("occ_thresh", rclcpp::ParameterValue(0.25));
    this->declare_parameter("maxRange", rclcpp::ParameterValue(0.0));
